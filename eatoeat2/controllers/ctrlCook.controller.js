...
db.categories_infos.find({}
                ...
                function(err,category){
                 ...
                 {  
                    ...
                    // var size = Object.keys(category).length;

                    //     for(var i=0;i<size;i++){
                    //          category_names.push(category[i].category_name);
   ...
   for(var i=0;i<occ_len;i++)
     ...
     for(var i=0;i<cuss_len;i++)
    {
            cuss_data.push(req.body.food_details.cuisine_types[i]);
                 ...
                 var date = new Date();
                var food_img='192.168.1.10:3000'+'/uploads/cook_uploads/'+date.getTime()+'.jpg';
...
db.cook_infos.findAndModify({
                                            ...
                                            update: {
                                                       ...
                                                       $unset:{'food_details.$.available_hours': {_id:mongojs.ObjectId(req.body._id)}
